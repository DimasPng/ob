...
class CuponController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Cupon']))
		{
			...
			if($g->affKomisType=="fixed" && $model->kind_id=="fixed")
			{
				if($model->sum >  $g->affKomis)
				{
					Y::user()->setFlash ('aff', Yii::t ('aff','Скидка должна быть меньше ваших коммиссионных!'));
					goto a;
				}
			}
			else if($g->affKomisType=="perc" && $model->kind_id=="perc")
			{
				if($model->sum >  $g->affKomis)
				{
					Y::user()->setFlash ('aff', Yii::t ('aff','Скидка должна быть меньше ваших коммиссионных!'));
				...
				Y::user()->setFlash ('aff', Yii::t ('aff','Тип скидки должен соответствовать типу коммиссионных!'));
				goto a;
			}
