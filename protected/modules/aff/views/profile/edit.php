        ...
        <div class="bg-light lter b-b wrapper-md">
            <div class="row">
                <div class="col-sm-6 col-xs-12">
                    <h1 class="m-n font-thin h3 text-black">Изменение профиля партнёра &quot;<?= $model->id ?>&quot;</h1>
                    <small class="text-muted">Изменение #<?php echo $model->id; ?></small>
                </div>                                
            </div>
        </div>
        <!-- / main header -->
            ...
            <div class="panel panel-default">
                ...
                <ol>   
                    ...
                    <fieldset class="submit" >
                        <?php echo CHtml::submitButton('Сохранить изменения', array ('class' => 'submit btn m-b-xs  btn-primary btn-addon btn-lg')); ?>
                    </fieldset>
