				...
				<table class="table" data-toggle-column="last" ui-jq="footable" ui-options='{
				    ...
				    <thead>
				      <tr>
						...
						<th  data-type="html">Рассылка</th>
						<th data-breakpoints="xs" data-type="html">Примечание</th>
						<th data-breakpoints="xs" data-type="html">Часы от подписки</th>
				    ...
				    <tbody>
				     ...
				     <?php foreach($records as $data){ ?>
				      <tr data-expanded="false">
				        ...
				        <td><?php echo Rass::item ($data->rass_id); ?></td>
				        <td><?php echo $data->comment; ?></td>
				        <td><?php echo $data->hours; ?></td>
				        <td>
				        	<div>
				        		<a href="<?=Y::bua()?>rletters/view/id/<?php echo $data->id; ?>" class="btn btn-sm btn-icon btn-success"><i class="fa fa-search"></i></a>
				        		<a href="<?=Y::bua()?>rletters/update/id/<?php echo $data->id; ?>" class="btn btn-sm btn-icon btn-info"><i class="fa fa-edit"></i></a>
				        		<a href="<?=Y::bua()?>rletters/delete/id/<?php echo $data->id; ?>" class="btn btn-sm btn-icon btn-danger"><i class="fa fa-trash-o"></i></a>
