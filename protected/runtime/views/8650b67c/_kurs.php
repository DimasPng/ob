<?php /* source file: /home/admin/web/yulialanske.ru/public_html/ob/protected/modules/admin/views/settings/general/_kurs.php */ ?>
<fieldset>
...
<ol>
    ...
    <div class="row">
		...
		<span class="hint">Здесь можно задать число, на которое будут умножены официальные курсы ЦБР в момент обновления - перед внесением в базу. Если Вы хотите для OB точные курсы ЦБР - впишите сюда 1.
    </div>    
    </li>        
