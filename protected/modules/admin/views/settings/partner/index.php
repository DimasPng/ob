<?php $this->pageTitle='Параметры партнёрской программы' ?>
    ...
    <div class="col">
        ...
        <div class="bg-light lter b-b wrapper-md">
            <div class="row">
                <div class="col-sm-6 col-xs-12">
                    ...
                    <small class="text-muted">Параметры партнёрской программы</small>
                </div>                                
            </div>
        </div>
        <!-- / main header -->
        <div class="wrapper-md" ng-controller="FlotChartDemoCtrl">
                ...
                <?php endif; ?>         
            <div class="panel panel-default mimimi">
               <?php $form=$this->beginWidget('CActiveForm', array(
                ...
                <ol>
                   ...
                   <!--  <li>
                    ...
                    <li>
                      ...
                      <li>
                        <?php echo $form->labelEx($model,'relation_partner'); ?>
                        <?php echo $form->checkBox($model,'relation_partner',array('class' => 'checkbox','uncheckValue' => 0)); ?>
                        <span class="hint">Если вы ставите эту галочку, то впредь, клиент будет автоматически закрепляться за партнером, купон которого он ввел.
                                            То есть теперь когда этот же клиент оформит заказ еще раз на какой-то товар и оплатит его, то комиссионные снова получит 
                                            этот же партнер. И пусть даже клиент не ввел купон снова. <br><br>

                                            Важный момент: комиссионные начислятся именно тогда, когда e-mail клиент вводит тот же самый.</span>
                    </li>
                ...
                <ol>
                    ...
                    <li>
                        ...
                        <span class="hint">Включает WebMoney Р как способ выплат - при регистрации, в профиле партнёра и в разделе "Выплаты"</span>
                    </li>
