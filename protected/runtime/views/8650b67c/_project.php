<?php /* source file: /home/admin/web/yulialanske.ru/public_html/ob/protected/modules/admin/views/settings/general/_project.php */ ?>
<fieldset>
...
<legend>Общие настройки</legend>
 ...
 <ol>
  ...
  <div class="row">
      ...
      <span class="hint">Данная опция указывает на то, что будет ли включён каталог (доступный по адресу <?=Y::bu()?>) или же будет отображаться просто страничка с информацией о том, что на данном сайте работает OrderBro.</span>
  </div>
  </li>    -->
...
<ol>
    ...
    <div class="row">
        ...
        <?php echo $form->textField($model,'nalozhCountries',array('size'=>60,'maxlength'=>255, 'class' => 'longtext text')); ?>
...
<legend>Политика конфиденциальности</legend>

<ol>
    
    <li>
    <div class="row">
        <?php echo $form->labelEx($model,'politic'); ?>
        <?php echo $form->checkBox($model,'politic',array('class' => 'checkbox','uncheckValue' => 0)); ?>            
    </div>
    </li>   

    <li>    
    <div class="row">
        <?php echo $form->labelEx($model,'politic_link'); ?>
        <?php echo $form->textField($model,'politic_link',array('size'=>60,'maxlength'=>255, 'class' => 'longtext text')); ?>
        <?php echo $form->error($model,'politic_link'); ?>       
    </div>    
    </li>    

    <li>    
    <div class="row">
        <?php echo $form->labelEx($model,'politic_oferta'); ?>
        <?php echo $form->textField($model,'politic_oferta',array('size'=>60,'maxlength'=>255, 'class' => 'longtext text')); ?>
        <?php echo $form->error($model,'politic_oferta'); ?>       
    </div>    
    </li>    
