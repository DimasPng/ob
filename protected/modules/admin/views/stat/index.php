...
<div class="col">
    ...
    box-shadow: 0 1px 1px rgba(0, 0, 0, .05);">
            ...
            <ol style="   padding-left: 23px;"><li><label>Статистика по каналам</label> <input style="    margin-bottom: 6px;" type='checkbox' class='checkbox' name='subacc' value='1'> </li></ol>
            ...
            <fieldset>
                ...
                <ol>
                    ...
                    <li>
                        <label>Всего продаж:</label><div class="oneitem"><?=count($porders)?></div>
                    ...
                    <li>
                    <label>Комиссионных 1 ур.:</label><div class="oneitem"><?=H::mysum($com1)?> рублей</div>
                    </li>
                    
                    <li>
                    <label>Комиссионных 2 ур.:</label><div class="oneitem"><?=H::mysum($com2)?> рублей</div>
                    </li>
                    
                    <li>
                    <label>Комиссионных всего:</label><div class="oneitem"><?=H::mysum($com1 + $com2)?> рублей</div>
                    </li>
                    
                    <li>&nbsp;</li>
                    
                    <li>
                    <label>Чистая прибыль:</label><div class="oneitem"><?=H::mysum($totalsum - $com1 - $com2)?> рублей</div>
                    </li>
           ...
           <table class="table" data-toggle-column="last" ui-jq="footable" ui-options='{
                ...
                <p>&nbsp;</p>
                <p >Для использования "своих" каналов (учёта кликов и конверсий) нужно использовать ссылку вида:<br><br>
                    
                    <b><?=Y::bu();?>ch/go/id/<span style="color:#C00">идтовара</span>/k/<span style="color:#080">нужный_канал</span></b>
                </p>
