<?php /* source file: /home/admin/web/yulialanske.ru/public_html/ob/protected/views//main/_statuses.php */ ?>

    
    <h3 style="padding-left: 35px;">Информация о статусах</h3>
...
<fieldset style="padding:15px;">
        ...
        <p><b>Информация о статусах для заказа</b><br>
            <span >(* помечены статусы, обзначающие уже реально оплаченные заказы)</span></p>                    
