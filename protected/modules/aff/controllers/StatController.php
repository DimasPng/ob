	...
	public function actionIndex()
	{
            ...
            if (!empty($thegood)) {
                ...
                if (!empty ($dwhere)) {
                 ...
                 //   $clicks = Click::allData ('partner_id = :pid AND date > '.$startDate.' AND date < '.$stopDate.' AND ('.$dwhere.')',$dargs);
                } else {
                   // $clicks = Click::allData ('partner_id = :pid AND date > '.$startDate.' AND date < '.$stopDate,array());                   
                    
                    $clicks = S::model()->findAll('p_id = :pid AND date >= '.$xstartdate.' AND date <= '.$xstopdate,$dargs);
                    //$clicks = Click::model()->findAll('partner_id = :pid AND date > '.$startDate.' AND date < '.$stopDate);
                }   
                ...
                //Теперь для начисленных заказов
