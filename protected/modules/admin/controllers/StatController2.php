	...
	public function actionIndex()
	{
            ...
            if (!empty($thegood)) {
                ...
                if (!empty ($dwhere) && $sbcheck) {
                    $clicks2 = S::model()->findAll('p_id = "om2sys" AND date >= '.$xstartdate.' AND date <= '.$xstopdate.' AND ('.$dwhere.')',$dargs);     
                } else {
                    $clicks2 = S::model()->findAll('p_id = "om2sys" AND date >= '.$xstartdate.' AND date <= '.$xstopdate,$dargs);
                }   
