<?php /* source file: /home/admin/web/yulialanske.ru/public_html/ob/protected/modules/admin/views/settings/general/_other.php */ ?>
<fieldset>
...
<legend>Настройки активности подписчиков</legend>

<ol>

    <li>    
    <div class="row">
        Добавлять подписчика в список НЕ активных, когда он<br>
        В течении    <?php echo $form->textField($model,'count_click',array('size'=>60,'maxlength'=>50, 'class' => 'numeric')); ?>       <?php echo $form->error($model,'count_click'); ?>
        рассылок не кликал по ссылкам в письмах <?php echo $form->textField($model,'day_click',array('size'=>60,'maxlength'=>50, 'class' => 'numeric')); ?><?php echo $form->error($model,'day_click'); ?> дней
