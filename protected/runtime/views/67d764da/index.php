<?php /* source file: /home/admin/web/yulialanske.ru/public_html/ob/protected/modules/admin/views/settings/my/index.php */ ?>
        ...
        <div class="bg-light lter b-b wrapper-md">
            <div class="row">
                <div class="col-sm-6 col-xs-12">
                    ...
                    <small class="text-muted">Мои данные</small>
                </div>                                
            </div>
        </div>
        <!-- / main header -->
            ...
            <div class="panel panel-default">
                ...
                <ol>
                    ...
                    <li>
                        ...
                        <span class="hint">Укажите URL-адрес (начиная с http://) Вашего основного проекта. Обычно подставляется внизу различных писем.</span>
                    </li>
