<?php /* source file: /home/admin/web/yulialanske.ru/public_html/ob/protected/modules/admin/views/settings/paysystems/_qiwi.php */ ?>
<fieldset>

    <legend>Параметры приёма платежей через Qiwi</legend>

    <a target="_blank" href="https://qiwi.com/"><img src="<?=Y::bu()?>images/admin/pay/qiwi.jpg" style="padding:20px 25px;    width: 240px;"></a>
...
<br>
<?=H::moredivAll('данные для настройки','qiwi') ?>
<fieldset>
