<?php /* source file: /home/admin/web/yulialanske.ru/public_html/ob/protected/modules/admin/views/settings/paysystems/_yandex.php */ ?>
<fieldset>

    <legend>Параметры приёма платежей через Яндекс.Деньги</legend>

    <a target="_blank" href="https://money.yandex.ru/"><img src="<?=Y::bu()?>images/admin/pay/yandex.png" style="padding:0px 25px;    width: 240px;"></a>
...
<br />
<?=H::moredivAll('данные для настройки','yandex') ?>
