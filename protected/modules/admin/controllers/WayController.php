...
class WayController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Way']))
		{
			$model->attributes=$_POST['Way'];
			if($model->save()) {
				Y::user()->setFlash ('admin','Запись добавлена');
				$this->redirect(array('view','id'=>$model->way_id));
			}
		}
	...
	{
            //{KG}
		$model=new Way('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Way']))
			$model->attributes=$_GET['Way'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='way-form')
		{
