				...
				<table class="table" data-empty="Ничего не найдено"  data-toggle-column="last" ui-jq="footable" ui-options='{
				    ...
				    <thead>
				      <tr>
						...
						<th data-breakpoints="xs" data-type="html">Количество продаж</th>
						<th data-breakpoints="xs" data-type="html">Комиссия</th>
				    ...
				    <tbody>
				     ...
				     <?php foreach($records as $data){ ?>
				      <tr data-expanded="false">
				        ...
				        <td><?php echo $data->komis.(($data->komis_type=="fixed")?" (в валюте)":"%"); ?></td>

				        <td>
				        	<div>
				        		<a href="<?=Y::bua()?>partnerauto/view/id/<?php echo $data->id; ?>" class="btn btn-sm btn-icon btn-success"><i class="fa fa-search"></i></a>
				        		<a href="<?=Y::bua()?>partnerauto/update/id/<?php echo $data->id; ?>" class="btn btn-sm btn-icon btn-info"><i class="fa fa-edit"></i></a>
				        		<a href="<?=Y::bua()?>partnerauto/delete/id/<?php echo $data->id; ?>" class="btn btn-sm btn-icon btn-danger"><i class="fa fa-trash-o"></i></a>
