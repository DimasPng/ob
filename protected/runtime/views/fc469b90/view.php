<?php /* source file: /home/admin/web/yulialanske.ru/public_html/ob/protected/modules/admin/views/bill/view.php */ ?>
<?php $this->pageTitle='Просмотр счёта' ?><?

$this->menu=array(
	array('label'=>'Список счетов', 'url'=>array('index'), 'itemOptions' => array ('class' => 'rmenu_list')),
	array('label'=>'Удалить счет', 'url'=>array('delete', 'id'=>$model->id), 'itemOptions' => array ('class' => 'rmenu_edit')),
);
?>
        ...
        <div class="bg-light lter b-b wrapper-md">
            <div class="row">
                <div class="col-sm-6 col-xs-12">
                    <h1 class="m-n font-thin h3 text-black">Счета</h1>
                    <small class="text-muted">Просмотр счёта №<?php echo $model->id; ?></small>
                </div>                                
            </div>
        </div>
        <!-- / main header -->
        <div class="wrapper-md" ng-controller="FlotChartDemoCtrl">
            ...
            <div class="panel panel-default">
                ...
                <fieldset class="submit" style="margin-top:20px;">
                        <?= CHtml::submitButton('Изменить статус/данные', array ('class' => 'submit btn m-b-xs  btn-primary btn-addon btn-lg xxxx','id'=>'subm')); ?>
                </fieldset>
               ...
               <fieldset>
                ...
                <p>Выберите какой статус Вы хотите установить и нажмите <strong>"Установить"</strong></p>
